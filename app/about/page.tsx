  ...
  return (
    <>
      <style>{`
        ...
        h1 { font-family: 'Cormorant Garamond', serif; font-size: clamp(54px, 7vw, 86px); line-height: 1.08; letter-spacing: -0.04em; font-weight: 600; max-width: 900px; margin-bottom: 32px; }
