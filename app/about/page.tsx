  ...
  return (
    <>
      <style>{`
        ...
        .section-title { font-family: 'Cormorant Garamond', serif; font-size: 42px; line-height: 1.12; font-weight: 600; margin-bottom: 22px; }
        ...
        .panel-title { font-family: 'Cormorant Garamond', serif; font-size: 30px; line-height: 1.12; margin-bottom: 12px; }
        ...
        .value-title { font-family: 'Cormorant Garamond', serif; font-size: 30px; line-height: 1.12; margin-bottom: 14px; }
        ...
        .cta-title { font-family: 'Cormorant Garamond', serif; font-size: 42px; line-height: 1.12; color: #0D1B2A; font-weight: 600; }
