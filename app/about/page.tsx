      ...
      <main className="page">
        ...
        <section className="wrap">
          ...
          <h1>
            ...
            <span className="gold">clarity, discipline, and execution.</span>
          </h1>
            ...
            <div className="values-grid">
              <div className="value-card">
                ...
                <p className="value-body">
                  We help teams understand what is working, what is not, and where
                  operational changes can create the greatest impact.
                </p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-body">
                  We turn scattered processes, unclear responsibilities, and informal
                  workflows into practical systems that are easier to manage.
                </p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-body">
                  We support the follow-through required to move work forward,
                  coordinate stakeholders, and turn plans into measurable progress.
                </p>
              </div>
            </div>
          </section>
